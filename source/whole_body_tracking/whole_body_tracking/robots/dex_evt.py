...
from motrix_envs.managers.adapter import MjcfFileCfg
...
MJCF_PATH = Path(__file__).resolve().parents[4] / "xmls" / "scene_dex_evt.xml"


DEX_EVT_CFG = ArticulationCfg(
    spawn=MjcfFileCfg(asset_path=MJCF_PATH),
    body_name="pelvis",
