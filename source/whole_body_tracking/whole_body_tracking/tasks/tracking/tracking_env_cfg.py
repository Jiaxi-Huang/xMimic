...
from motrix_envs.torch.adapter import InteractiveSceneCfg
from motrix_envs.torch.adapter import ContactSensorCfg
...
class RewardsCfg:
    ...
    joint_limit = RewTerm(
        ...
        weight=-1.0,
        params={"cap": 5.0, "asset_cfg": SceneEntityCfg("robot", joint_names=[".*"])},
    )
